...
public class Press_Space_To_Fire : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /*A fix il faut que la bullet aille perpendiculairement par rapport au monde*/
        float fireTime = Time.time;
        if ((Input.GetKeyDown("space") || (joyButton1 != null && joyButton1.Pressed)) && fireTime - gunLastTrigger > 0.5)
        {
